/*Adrineh Khodaverdian
 ...
 -----------------------------------------------------------------
                        ITApplication
 -----------------------------------------------------------------
-BackOfficeITApplicationFile: ofstream
-fileN: string
 -----------------------------------------------------------------
+~ITApplication()
+ITApplication(name : const string & , last: const string & , openD: const Date &, deadline: const Date &, dateToday: const Date &,title: const string & , jobType const string & , jobLocation const string &,  majorEdu: const string & , levelEdu: const string & , skill: const string &, max:  int);
...
class ITApplication : public Application
{
    
    private:
        ofstream BackOfficeITApplicationFile;
        string fileN;
    public:
        virtual ~ITApplication();
        ITApplication(const string & = "NULL", const string & = "NULL", const Date & = Date(), const Date & = Date(), const Date & = Date(), const string & = "NULL", const string & = "NULL",  const string & = "NULL", const string & = "NULL", const string & = "NULL", const string & = "NULL", int =20);
        /**************************************************************************************************************
